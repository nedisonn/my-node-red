...
<script type="text/javascript">RED.nodes.registerType("api-current-state",{category:"home_assistant",color:"#5BCBF7",inputs:1,outputs:1,outputLabels:nodeVersion.ifStateLabels,icon:"ha-current-state.svg",paletteLabel:"current state",label:function(){return this.name||`current_state: ${this.entity_id}`},labelStyle:nodeVersion.labelStyle,defaults:{name:{value:""},server:{value:"",type:"server",required:!0},version:{value:1},outputs:{value:1},halt_if:{value:""},halt_if_type:{value:"str"},halt_if_compare:{value:"is"},override_topic:{value:!1},entity_id:{value:""},state_type:{value:"str"},state_location:{value:"payload"},override_payload:{value:"msg"},entity_location:{value:"data"},override_data:{value:"msg"},blockInputOverrides:{value:!1}},oneditprepare:function(){nodeVersion.check(this);const e=$("#entity_id"),t=$("#node-input-state_location"),a=$("#node-input-entity_location"),i=this;haServer.init(i,"#node-input-server"),haServer.autocomplete("entities",(t=>{i.availableEntities=t,e.autocomplete({source:i.availableEntities,minLength:0})})),e.val(i.entity_id),void 0===i.state_location&&(t.val("payload"),$("#node-input-override_payload").val(!1===i.override_payload?"none":"msg")),void 0===i.entity_location&&(a.val("data"),$("#node-input-override_data").val(!1===i.override_data?"none":"msg"));const n={value:"none",label:"None",hasValue:!1};t.typedInput({types:["msg","flow","global",n],typeField:"#node-input-override_payload"}),a.typedInput({types:["msg","flow","global",n],typeField:"#node-input-override_data"}),void 0===i.state_type&&$("#node-input-state_type").val("str"),void 0===i.halt_if_compare&&$("#node-input-halt_if_compare").val("is"),ifState.init("#node-input-halt_if","#node-input-halt_if_compare","currentState")},oneditsave:function(){this.entity_id=$("#entity_id").val();let e=$("#node-input-halt_if").val()?2:1;0===this.version&&2===e&&(e=JSON.stringify({0:1,1:0})),$("#node-input-outputs").val(e),nodeVersion.update(this)}});</script>
<script type="text/x-red" data-template-name="api-current-state"><input type="hidden" id="node-input-version"><div class="form-row"><label for="node-input-name"><i class="fa fa-tag"></i> Name</label> <input type="text" id="node-input-name" placeholder="Name"> <input type="hidden" id="node-input-outputs"></div><div class="form-row"><label for="node-input-server"><i class="fa fa-server"></i> Server</label> <input type="text" id="node-input-server"></div><div class="form-row"><label for="entity_id"><i class="fa fa-cube"></i> Entity ID</label> <input type="text" id="entity_id"></div><div class="form-row"><label for="node-input-halt_if_compare"><i class="fa fa-check-square"></i> If State</label> <select type="text" id="node-input-halt_if_compare" style="width:20%"><option value="is">is</option><option value="is_not">is not</option><option value="lt">&lt;</option><option value="lte">&lt;=</option><option value="gt">&gt;</option><option value="gte">&gt;=</option><option value="includes">in</option><option value="does_not_include">not in</option><option value="jsonata">JSONata</option></select> <input type="text" id="node-input-halt_if" style="width:50%"> <input type="hidden" id="node-input-halt_if_type"></div><div class="form-row"><label for="node-input-state_type"><i class="fa fa-tint"></i> State Type</label> <select type="text" id="node-input-state_type" style="width:auto"><option value="str">String</option><option value="num">Number</option><option value="habool">Boolean</option></select></div><div class="form-row" id="state_location"><label for="node-input-state_location">State Location</label> <input type="hidden" id="node-input-override_payload"> <input type="text" id="node-input-state_location" style="width:70%"></div><div class="form-row" id="entity_location"><label for="node-input-entity_location">Entity Location</label> <input type="hidden" id="node-input-override_data"> <input type="text" id="node-input-entity_location" style="width:70%"></div><div class="form-row checkbox-option"><input type="checkbox" id="node-input-override_topic">&nbsp; <label for="node-input-override_topic">Override Topic</label></div><div class="form-row checkbox-option"><input type="checkbox" id="node-input-blockInputOverrides">&nbsp; <label for="node-input-blockInputOverrides">Block Input Overrides</label></div></script>
<script type="text/x-red" data-help-name="api-current-state"><p>Returns the current state of an entity. Useful for using conditional logic to automation flows.</p><h3>Configuration</h3><dl class="message-properties"><dt>Entity ID <span text="required" class="badge">required</span><span class="property-type">string</span></dt><ul><li>Accepts <a href="https://zachowj.github.io/node-red-contrib-home-assistant-websocket/guide/mustache-templates.html" rel="noopener noreferrer">Mustache Templates</a></li></ul><dd>The id of the entity to return.</dd><dt>If State<span class="property-type">string</span></dt><dd>If the conditional statement is evaluated as true send the message to the first output otherwise send it to the second output. If blank there will only be one output.</dd><dd><strong>Also see:</strong></dd><ul><li><a href="https://zachowj.github.io/node-red-contrib-home-assistant-websocket/guide/conditionals.html" rel="noopener noreferrer">Conditionals</a></li></ul><dt>State Type<span class="property-type">string</span></dt><ul><li>Values: <code>string|number|boolean</code></li><li>Default: <code>string</code></li></ul><dd>Convert the state of the entity to the selected type. Boolean will be converted to true based on if the string is equal by default to (<code>y|yes|true|on|home|open</code>). Original value stored in <code>msg.data.original_state</code></dd><dt>State Location<span class="property-type">string</span></dt><ul><li>Default: <code>msg.payload</code></li></ul><dd>Customizable location for the entity&#x2019;s state.</dd><dt>Entity Location<span class="property-type">string</span></dt><ul><li>Default: <code>msg.data</code></li></ul><dd>Customizable location for the entity object. Defaults to</dd><dt>Override Topic<span class="property-type">boolean</span></dt><ul><li>Default: <code>false</code></li></ul><dd>Write entity id to msg.topic</dd><dt>Block Input Overrides<span class="property-type">boolean</span></dt><ul><li>Default: <code>false</code></li></ul><dd>Stop msg.payload values from overriding local config</dd></dl><h3>Inputs</h3><dl class="message-properties"><dt>payload.entity_id<span class="property-type">string</span></dt></dl><h3>Outputs</h3><dl class="message-properties"><dt>topic<span class="property-type">string</span></dt><dd>Latest current state object received from home assistant</dd><dt>payload<span class="property-type">string</span></dt><dt>data<span class="property-type">object</span></dt><dd>Latest current state object received from home assistant</dd><dd>Example output of the data property:</dd><pre><code class="language-json">{
...
</code></pre><dt>data.state<span class="property-type">string</span></dt><dd>Main attribute state value, examples: &apos;on&apos;, &apos;off&apos;, &apos;home&apos;, &apos;open&apos;, &apos;closed&apos;, etc...</dd><dt>data.entity_id<span class="property-type">string</span></dt><dd>The entity to which this state belongs</dd><dt>data.attributes<span class="property-type">object</span></dt><dd>Supported attributes of state set by Home Assistant</dd><dt>data.last_changed<span class="property-type">string</span></dt><dd>ISO Date string of last time entity state changed</dd><dt>data.last_updated<span class="property-type">string</span></dt><dt>data.timeSinceChangedMs<span class="property-type"></span></dt><dd>Milliseconds of last time entity state changed</dd></dl><h3>References</h3><dl class="message-properties"><ul><li><a href="https://home-assistant.io/docs/configuration/state_object/">Home Assistant State Objects</a></li></ul></dl></script>
