...
<script type="text/javascript">RED.nodes.registerType("ha-wait-until",{category:"home_assistant",color:"#5BCBF7",inputs:1,outputs:1,outputLabels:["","timed out"],icon:"ha-wait-until.svg",paletteLabel:"wait until",label:function(){return this.name||"wait until"},labelStyle:nodeVersion.labelStyle,defaults:{name:{value:""},server:{value:"",type:"server",required:!0},outputs:{value:1},entityId:{value:""},entityIdFilterType:{value:"exact"},property:{value:""},comparator:{value:"is"},value:{value:""},valueType:{value:"str"},timeout:{value:0},timeoutType:{value:"num"},timeoutUnits:{value:"seconds"},entityLocation:{value:"data"},entityLocationType:{value:"none"},checkCurrentState:{value:!0},blockInputOverrides:{value:!0}},oneditprepare:function(){const e=this;haServer.init(e,"#node-input-server");let t=[],n=[];haServer.autocomplete("entities",(e=>{t=e,$("#node-input-entityId").autocomplete({source:t,minLength:0})})),haServer.autocomplete("properties",(e=>{n=e,$("#node-input-property").autocomplete({source:n,minLength:0})})),void 0===e.checkCurrentState&&$("#node-input-checkCurrentState").prop("checked",!1);const a={value:"entity",label:"entity."},o=["str","num","bool","re","jsonata","msg","flow","global",a];$("#node-input-value").typedInput({default:"str",types:o,typeField:"#node-input-valueType"}),$("#node-input-comparator").change((function(e){let t=o;switch($("#node-input-property").prop("disabled","jsonata"===e.target.value),e.target.value){case"is":case"is_not":break;case"lt":case"lte":case"gt":case"gte":t=["num","jsonata","msg","flow","global",a];break;case"includes":case"does_not_include":t=["str","jsonata","msg","flow","global"];break;case"jsonata":t=["jsonata"]}$("#node-input-value").typedInput("types",t)})),$("#node-input-timeout").typedInput({default:"num",types:["num","jsonata"],typeField:"#node-input-timeoutType"}).on("change",(function(t,n){!0!==n&&(e.outputs="jsonata"===n||"num"===n&&this.value>0?2:1)}));$("#node-input-entityLocation").typedInput({types:["msg","flow","global",{value:"none",label:"None",hasValue:!1}],typeField:"#node-input-entityLocationType"}),void 0===e.blockInputOverrides&&$("#node-input-blockInputOverrides").prop("checked",!0);const u=$("#node-input-entityIdFilterType");u.val(e.entityIdFilterType||"exact"),u.on("change",(function(){$(".exact-only").toggle("exact"===u.val())}))}});</script>
