...
<script type="text/javascript">function generateId(e){const o="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";return Array.from({length:e},(()=>o[Math.floor(Math.random()*o.length)])).join("")}RED.nodes.registerType("ha-webhook",{category:"home_assistant",color:"#399CDF",outputs:1,outputLabels:"",icon:"ha-webhook.svg",paletteLabel:"webhook",label:function(){return this.name||"webhook"},labelStyle:nodeVersion.labelStyle,defaults:{name:{value:""},server:{value:"",type:"server",required:!0},outputs:{value:1},webhookId:{value:generateId(32),required:!0},payloadLocation:{value:"payload"},payloadLocationType:{value:"msg"},headersLocation:{value:"headers"},headersLocationType:{value:"none"}},oneditprepare:function(){haServer.init(this,"#node-input-server");const e=$("#node-input-webhookId");exposeNode.init(this),$("#copyId").on("click",(function(){const o=e[0],t=o.value;o.value=`https://<ip>:<port>/api/webhook/${t}`,o.select(),o.setSelectionRange(0,99999),document.execCommand("copy"),o.value=t})),$("#refresh").on("click",(function(){e.val(generateId(32))}));const o={value:"none",label:"None",hasValue:!1};$("#node-input-payloadLocation").typedInput({types:["msg","flow","global",o],typeField:"#node-input-payloadLocationType"}),$("#node-input-headersLocation").typedInput({types:["msg","flow","global",o],typeField:"#node-input-headersLocationType"})}});</script>
<script type="text/x-red" data-template-name="ha-webhook"><div class="form-row"><label for="node-input-name"><i class="fa fa-tag"></i> Name</label> <input type="text" id="node-input-name" placeholder="Name"> <input type="hidden" id="node-input-outputs"></div><div class="form-row"><label for="node-input-server"><i class="fa fa-server"></i> Server</label> <input type="text" id="node-input-server"></div><div class="form-row"><label for="node-input-webhookId"><i class="fa fa-cube"></i> ID</label><div style="display:inline-block;position:relative;width:70%;height:20px"><div style="position:absolute;left:0;right:80px"><input type="text" id="node-input-webhookId" style="width:100%"></div><a id="copyId" class="editor-button" style="position:absolute;right:0;top:0"><i class="fa fa-copy"></i></a> <a id="refresh" class="editor-button" style="position:absolute;right:40px;top:0"><i class="fa fa-refresh"></i></a></div></div><div class="form-row" id="payloadLocation"><label for="node-input-payloadLocation">Payload</label> <input type="hidden" id="node-input-payloadLocationType"> <input type="text" id="node-input-payloadLocation" style="width:70%"></div><div class="form-row" id="headersLocation"><label for="node-input-headersLocation">Headers</label> <input type="hidden" id="node-input-headersLocationType"> <input type="text" id="node-input-headersLocation" style="width:70%"></div></script>
<script type="text/x-red" data-help-name="ha-webhook"><p>Outputs the data received from the created webhook in Home Assistant</p><div class="custom-block warning"><p class="custom-block-title">WARNING</p><p><em>Needs <a href="https://github.com/zachowj/hass-node-red">Custom Integration</a> installed in Home Assistant for this node to function</em></p></div><h3>Configuration</h3><dl class="message-properties"><dt>ID<span class="property-type">string</span></dt><dd>A string to be used for the webhook URL in Home Assistant.</dd><dt>Payload<span class="property-type">string</span></dt><dd>Customizable location for the webhook payload. Defaults to msg.payload</dd><dt>Headers<span class="property-type">number</span></dt><dd>Customizable location for the webhook request headers.</dd></dl><h3>Outputs</h3><dl class="message-properties"><dt>topic<span class="property-type">string</span></dt><dd>webhook ID</dd><dt>payload<span class="property-type">object | number | string</span></dt><dd>The parsed body from the webhook request.</dd></dl><!-- TODO: add headers info --></script>
