...
<script type="text/javascript">RED.nodes.registerType("ha-get-entities",{category:"home_assistant",color:"#5BCBF7",inputs:1,outputs:1,icon:"ha-get-entities.svg",paletteLabel:"get entities",label:function(){return this.name||"get entities"},labelStyle:nodeVersion.labelStyle,defaults:{server:{value:"",type:"server",required:!0},name:{value:""},rules:{value:[{property:"",logic:"is",value:"",valueType:"str"}]},output_type:{value:"array"},output_empty_results:{value:!1},output_location_type:{value:"msg"},output_location:{value:"payload"},output_results_count:{value:1,validate:function(t){return"random"!==$("#node-input-output_type").val()||Number.isInteger(Number(t))}}},oneditprepare:function(){const t=[{value:"is",text:"is"},{value:"is_not",text:"is not"},{value:"lt",text:"<"},{value:"lte",text:"<="},{value:"gt",text:">"},{value:"gte",text:">="},{value:"includes",text:"in"},{value:"does_not_include",text:"not in"},{value:"starts_with",text:"starts with"},{value:"in_group",text:"in group"},{value:"jsonata",text:"JSONata"}],e={value:"entity",label:"entity."},a=["str","num","bool","re","jsonata","msg","flow","global",e],o=$("#logic");let n=[];haServer.init(this,"#node-input-server"),haServer.autocomplete("properties",(t=>{n=t,$(".input-property").autocomplete({source:n,minLength:0})})),o.editableList({addButton:!0,removable:!0,height:"auto",addItem:function(o,u,s){const l=$("<div />",{class:"editable-list-row"}).appendTo(o),i=$("<div />",{class:"editable-list-row"}).appendTo(o);Object.prototype.hasOwnProperty.call(s,"logic")||(s.logic="is"),$("<span />",{text:"Property",style:"padding-right: 47px;"}).appendTo(l);const p=$("<input />",{type:"text",class:"input-property",style:"margin-left: 5px;"}).appendTo(l).val(s.property);p.autocomplete({source:n,minLength:0});const r=$("<select/>",{style:"margin-right: 5px;width: auto;"}).appendTo(i).change((function(t){let o=a;switch(p.prop("disabled","jsonata"===t.target.value),t.target.value){case"is":case"is_not":break;case"lt":case"lte":case"gt":case"gte":o=["num","jsonata","msg","flow","global",e];break;case"includes":case"does_not_include":case"starts_with":case"in_group":o=["str","jsonata","msg","flow","global",e];break;case"jsonata":o=["jsonata"]}c.typedInput("types",o)}));for(const e in t)r.append($("<option></option>").val(t[e].value).text(t[e].text));const c=$("<input />",{class:"input-value",type:"text",style:"width: 70%;"}).appendTo(i).val(s.value).typedInput({types:a});c.typedInput("type",s.valueType),r.val(s.logic).trigger("change")}}),o.editableList("addItems",this.rules),$("#node-input-output_location").typedInput({types:["msg","flow","global"],typeField:"#node-input-output_location_type"}),$("#node-input-output_results_count").spinner({min:1}),$("#node-input-output_type").on("change",(function(t){switch($(".output-option").hide(),t.target.value){case"array":$("#output_empty_results").show(),$("#output_location").show();break;case"count":$("#output_location").show();break;case"random":$("#output_results_count").show(),$("#output_location").show()}})).trigger("change")},oneditsave:function(){const t=$("#logic").editableList("items"),e=this;e.rules=[],t.each((function(t){const a=$(this),o=a.find(".input-property").val(),n=a.find("select").val(),u=a.find(".input-value").typedInput("value"),s=a.find(".input-value").typedInput("type");e.rules.push({property:o,logic:n,value:u,valueType:s})}))}});</script>
<script type="text/x-red" data-template-name="ha-get-entities"><div class="form-row"><label for="node-input-name"><i class="fa fa-tag"></i> Name</label> <input type="text" id="node-input-name" placeholder="Name"></div><div class="form-row"><label for="node-input-server"><i class="fa fa-server"></i> Server</label> <input type="text" id="node-input-server"></div><div class="form-row"><ol id="logic"></ol></div><div class="form-row"><label for="node-input-output_type">Output Type</label> <select id="node-input-output_type" style="width:70%"><option value="array">Array</option><option value="count">Count</option><option value="random">Random</option><option value="split">Split</option></select></div><div class="form-row checkbox-option output-option" id="output_empty_results"><input type="checkbox" id="node-input-output_empty_results"> <label for="node-input-output_empty_results">Send Empty Results</label></div><div class="form-row output-option" id="output_results_count"><label for="node-input-output_results_count" style="width:160px">Max Number of Results</label> <input type="text" id="node-input-output_results_count" style="width:150px"></div><div class="form-row output-option" id="output_location"><label for="node-input-output_location">Output Location</label> <input type="hidden" id="node-input-output_location_type"> <input type="text" id="node-input-output_location" style="width:70%"></div></script>
<script type="text/x-red" data-help-name="ha-get-entities"><p>Get Entities based on search criteria</p><h3>Configuration</h3><dl class="message-properties"><dt>Search Criteria<span class="property-type"></span></dt><dd>All search criteria have to be true for an entity to be valid.</dd><dt>Property<span class="property-type"></span></dt><dd>Has autocompleted with all properties currently set on all loaded entities.</dd></dl><h3>Inputs</h3><dl class="message-properties"><dt>payload<span class="property-type">Object</span></dt><dd>Override config values by passing in a property with a valid value.</dd><ul><li>rules array<ul><li>property string</li><li>logic string</li><li>value string</li><li>valueType string</li></ul></li><li>outputType string</li><li>outputEmptyResults boolean</li><li>outputLocationType string</li><li>outputLocation string</li><li>outputResultscount number</li></ul></dl><h3>Outputs</h3><dl class="message-properties"><dt>Array<span class="property-type">Array</span></dt><dd>Sends an array of state objects from search criteria to the Output Location.</dd><dt>Count<span class="property-type">number</span></dt><dd>Return the total count of valid entities.</dd><dt>Random<span class="property-type">Object|Array</span></dt><dd>Return a random object or array from the available state objects to the Output Location. When <code>One Max Results</code> is selected it will return an object and when more than one is selected will always return an array of state objects.</dd><dt>Split<span class="property-type">msg</span></dt><dd>Sends a message for each state object. In the same format as if the split node was used.</dd></dl><h3>State Object Format</h3><dl class="message-properties"><dd>Sample output when the Output Type is an array:</dd><pre><code class="language-json">[
  {
